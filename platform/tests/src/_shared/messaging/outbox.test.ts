...
import { DynamoDbOutboxStore } from "@warmpact/adapters/_shared/messaging/dynamodb-outbox-store.js";
import { startOutboxWorker } from "@warmpact/adapters/_shared/messaging/outbox-worker.js";
import { createInProcessIntegrationEventBus } from "@warmpact/adapters/_shared/messaging/in-process-integration-event-bus.js";
