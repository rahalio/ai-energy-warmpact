/**
 * Underwriting API Types
 *
 * API contract types come from @warmpact/core.
 * This file contains ONLY re-exports - no local API contract definitions.
 */

// ============================================================================
// API Type Re-exports (from @warmpact/core)
// ============================================================================
...
export type {
  // Add types from @warmpact/core/underwriting
} from "@warmpact/core";

// Re-export with alias for backward compatibility if needed
// export type CoreUnderwritingItem = UnderwritingItem;
