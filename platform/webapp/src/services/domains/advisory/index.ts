 ...
 * Advisory Domain
 *
 * Barrel export for advisory service, types, hooks, and view models.
 *
 * Architecture Rules:
...
// ============================================================================
export { advisoryService } from './advisory.service';

// ============================================================================
// Facade (high-level API for components)
// ============================================================================
export { advisoryFacade } from './facade';
...
export type * from './advisory.api-types';
