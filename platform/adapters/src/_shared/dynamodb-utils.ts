 ...
 *
 * @returns The core table name (e.g., "warmpact-core-dev")
 ...
 *
 * @returns The base table name (e.g., "warmpact-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "warmpact-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "warmpact-app-realtime-dev")
