/**
 * Guarantees Services - Application Layer Export
 *
...
/**
 * Guarantees Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for guarantees domain.
 */
