/**
 * Advisory Services - Application Layer Export
 *
...
/**
 * Advisory Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for advisory domain.
 */
