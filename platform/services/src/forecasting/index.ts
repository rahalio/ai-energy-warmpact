/**
 * Forecasting Services - Application Layer Export
 *
...
/**
 * Forecasting Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for forecasting domain.
 */
